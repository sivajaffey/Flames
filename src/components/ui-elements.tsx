...
import { TextField, Container, Grid2, AppBar, Toolbar } from '@mui/material';
...
export const Grid = (props) => {
    return <Grid2 {...props}>{props.content}</Grid2>
}

export const NavBar = (props) => {
    return <AppBar {...props}>{props.content}</AppBar>
}

export const NavToolBar = (props) => {
    return <Toolbar {...props}>{props.content}</Toolbar>
}
